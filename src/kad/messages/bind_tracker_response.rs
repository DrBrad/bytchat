...
#[derive(Clone)]
pub struct BindTrackerResponse {
    uid: Option<UID>,
    tid: [u8; TID_LENGTH],
...
impl Default for BindTrackerResponse {
...
impl MessageBase for BindTrackerResponse {
...
impl MethodMessageBase for BindTrackerResponse {
